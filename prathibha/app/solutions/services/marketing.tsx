        ...
        <ScrollView style={styles.container} contentContainerStyle={styles.contentContainer}>
            <View style={styles.header}>
                <View style={styles.iconContainer}>
                    <Ionicons name="trending-up" size={40} color="#00ffcc" />
                </View>
            ...
            <View style={styles.section}>
                ...
                <Text style={styles.description}>
                    ...
                    In the meantime, please contact us to discuss your digital marketing needs.
                </Text>
            </View>

            <View style={styles.ctaSection}>
                <Text style={styles.ctaTitle}>Ready to Boost Your Online Presence?</Text>
                <Text style={styles.ctaText}>
                    Contact us to discuss your digital marketing requirements and grow your business online.
                </Text>
                <TouchableOpacity
